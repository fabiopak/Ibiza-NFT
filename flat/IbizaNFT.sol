...
contract IbizaNFT is Context, AccessControlEnumerable, ERC721Enumerable, ERC721Burnable, ERC721Pausable {
    ...
    function mintComplete(address creator, address recipient, uint256 tokenId, string memory _tokenURI) public onlyRole(MINTER_ROLE) {
